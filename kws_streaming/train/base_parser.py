...
def base_parser():
  ...
  parser.add_argument(
      '--validation_list_dir',
      type=str,
      default='validation_list.txt',
      help='filename of validation set list.')
  parser.add_argument(
      '--testing_list_dir',
      type=str,
      default='testing_list.txt',
      help='filename of test set list.')
  parser.add_argument(
  ...
  parser.add_argument(
      '--wanted_words',
      type=str,
      default='yeonghwagwan,doseogwan,jucha,yeonghwa,yeyak,eodi,hwakin,sigan,daechul,jari',
